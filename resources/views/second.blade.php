        ...
        <div class='row'>
            ...
            <div class="col-xl-4 col-lg-4 col-md-5 col-sm-12 d-flex align-items-center justify-content-center" style="height: 100vh;">
                <div class="d-flex justify-content-center align-items-center flex-column w-100">
                    ...
                    <a href="/third" class="w-75 p-2 rounded text-center" style="background-color:#0033A1; color:#FFFFFF;text-decoration:none;" type="submit" value="submit"><span class="fw-bold fs-5 text_Send ">SEND TEXT</span></a>
